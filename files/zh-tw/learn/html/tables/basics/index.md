...
有關太陽系星球的資訊 (真實資料取自 [Nasa's Planetary Fact Sheet - Metric](https://nssdc.gsfc.nasa.gov/planetary/factsheet/)**. )**
...
在這個單元裡我們將不會聚焦在 CSS 上，但是我們提供基本的 CSS 樣式表讓你做使用，這將會使你製作的表格比起毫無修飾的預設樣式更方便閱讀。你能在這找到[樣式表](https://github.com/mdn/learning-area/blob/main/html/tables/basic/minimal-table.css)，並且你也能找到一個適用於樣式表的[HTML 模版](https://github.com/mdn/learning-area/blob/main/html/tables/basic/blank-template.html) — 他們能一起讓你有個好起點來實驗 HTML 表格。
...
1. 第一件事，在自己的電腦複製一份新的[空白模板.html](https://github.com/mdn/learning-area/blob/main/html/tables/basic/blank-template.html) 以及 [簡易表格.css](https://github.com/mdn/learning-area/blob/main/html/tables/basic/minimal-table.css)
...
> **備註：** 你也可以在 GitHub 上看到 [simple-table.html](https://github.com/mdn/learning-area/blob/main/html/tables/basic/simple-table.html) ([see it live also](https://mdn.github.io/learning-area/html/tables/basic/simple-table.html)).
...
1. 首先, 複製 [dogs-table.html](https://github.com/mdn/learning-area/blob/main/html/tables/basic/dogs-table.html) and [minimal-table.css](https://github.com/mdn/learning-area/blob/main/html/tables/basic/minimal-table.css) 檔案到你的電腦。
...
> **備註：** 你可以在 GitHub 上的[dogs-table-fixed.html](https://github.com/mdn/learning-area/blob/main/html/tables/basic/dogs-table-fixed.html)找到我們寫好的完整的範例([直接看看長怎樣](https://mdn.github.io/learning-area/html/tables/basic/dogs-table-fixed.html)).
...
1. 首先，複製一份我們的 [animals-table.html](https://github.com/mdn/learning-area/blob/main/html/tables/basic/animals-table.html) 和 [minimal-table.css](https://github.com/mdn/learning-area/blob/main/html/tables/basic/minimal-table.css) 檔案在你的電腦上。這個 HTML 包含跟上面同樣的動物範例。
...
> **備註：** 你可以在 GitHub 上的 [animals-table-fixed.html](https://github.com/mdn/learning-area/blob/main/html/tables/basic/animals-table-fixed.html) 找到我們寫好的完整的範例 ([see it live also](https://mdn.github.io/learning-area/html/tables/basic/animals-table-fixed.html)).
