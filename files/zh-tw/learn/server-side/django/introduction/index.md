...
服務器端框架的受歡迎程度沒有任何可靠和明確的測量（儘管[Hot Frameworks](https://hotframeworks.com/)網站嘗試使用諸如計算每個平台的 GitHub 項目數量和 StackOverflow 問題的機制來評估流行度）。一個更好的問題是 Django 是否「足夠流行」，以避免不受歡迎的平台的問題。它是否繼續發展？如果你需要幫助，可以幫你嗎？如果你學習 Django，有機會獲得付費工作嗎？
