...
我們的社群是個地球村！我們傑出的貢獻者遍布全世界、涵蓋各種語言。如果你想更認識我們、或是需要任何幫忙，隨時歡迎你到我們的[討論區](https://discourse.mozilla.org/c/mdn/236)或 [IRC 頻道](irc://irc.mozilla.org#mdn)！你也可以追蹤我們的 Twitter 帳號「[@MozDevNet](https://twitter.com/MozDevNet)」獲得最新消息。如果你發現任何錯誤、或是你有任何話想跟我們說，都歡迎你發送推文給我們的作者和貢獻者！
...
請注意在以上範例中，「Mozilla Contributors」連結到該頁面的編輯歷史。參閱 [Best practices for attribution](https://wiki.creativecommons.org/wiki/Marking/Users) 獲得更多資訊。

> **備註：** 參閱 [MDN content on WebPlatform.org](/zh-TW/docs/MDN_content_on_WebPlatform.org) 了解更多有關如何在網站上使用和標註 MDN 內容的資訊。

在 2010 年 8 月 20 日以前新增到這個 wiki 的範例程式碼，是採用 [MIT 授權條款](https://opensource.org/license/mit)釋出。你應該在 MIT 模板中增加這些作者資訊：「© <最新的 wiki 更新日期> <寫下這段程式碼的人>」
...
你可以透過第三方工具來閱覽 MDN，例如 [Dash](https://kapeli.com/dashdash)（Mac OS 用）和 [Zeal](https://zealdocs.org/)（Linux 和 Windows 用）。

[Kapeli](https://kapeli.com/dash) 也發布了[離線 MDN docs](https://kapeli.com/dashmdn_offline) 涵蓋 HTML、CSS、JavaScript、SVG 和 XSLT。
...
MDN Web Docs（前身為*Mozilla Developer Network (MDN)*，更前身為 Mozilla Developer Center (MDC) 或 _Devmo_）專案始於 2005 年初，[Mozilla 基金會](https://foundation.mozilla.org/)從 AOL 得到了原始的 Netscape [DevEdge](https://web.archive.org/web/*/devedge.netscape.com) 授權。DevEdge 內容仍被視為可用，之後由志願者合併到今天的這個 wiki 以便日後的更新與維護。
