...
加入貢獻的第一步是要有 MDN 帳號，請參考[建立帳號說明](/docs/MDN/Contribute/Howto/Create_an_MDN_account)。注意，在建立 MDN 帳號之前，你需要有一個 [GitHub 帳號](https://github.com/signup)，因為我們已經使用 GitHub 作為登入驗證。
...
- [設定 Kuma 的組建環境](https://kuma.readthedocs.io/ex.dopa)（1 小時）
- [把你的程式更新到 Kuma 程式庫](https://github.com/mdn/kuma#readme) （1 小時）
...
- 從[MDN category in Bugs Ahoy](https://www.joshmatthews.net/bugsahoy/?mdn%3D1)修復[文件錯誤](/zh-TW/docs/MDN/Contribute/Howto/Resolve_a_mentored_developer_doc_request)（1 小時以上）
