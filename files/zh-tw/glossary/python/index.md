...
Python 是在 OSI 認可的開源許可證規範下開發的，使其能自由使用與分發，即使是商用亦然。目前 Python 許可證是由 [Python Software Foundation](https://www.python.org/psf-landing/) 管理的。

## 參見

- 維基百科的 [Python](https://zh.wikipedia.org/wiki/Python)
- [Python 官方教學文件](https://docs.python.org/3/tutorial/index.html)
- [Tutorialspoint Python 教學](https://www.tutorialspoint.com/python/index.htm)
