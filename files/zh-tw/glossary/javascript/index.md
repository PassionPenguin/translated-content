...
JavaScript（JS）是個程式語言。通常用於用戶端（client-side）的動態網頁腳本，不過也常藉由 [Node.js](https://nodejs.org/enen) 之類的軟體包，使用到{{Glossary("Server","伺服器")}}端（Server-side）。
...
最近，JavaScript 挾著非瀏覽器跨平台執行環境 [Node.js](https://nodejs.org/enen) 的巨大成功，重返了伺服器世界。電腦上的 Node.js 能讓 JavaScript 作為腳本語言使用以處理自動化。另外，還可以組建完整的 {{Glossary("HTTP")}} 與 {{Glossary("Web Sockets")}} 伺服器。
...
- [NodeSchool 的 javascripting 工作坊](https://nodeschool.io/#workshoppers)
- [codecademy.com 的 JavaScript 課程](https://www.codecademy.com/catalog/language/javascript)
- [John Resig 的 Learning Advanced JavaScript](https://johnresig.com/apps/learn/)

### 技術參考

- [最新的 ECMAScript 標準](https://ecma-international.org/publications-and-standards/standards/ecma-262/)
