...
> **警告：** 本页面上的链接通向各式各样的入门指导和培训教材。不管你是仅仅开始入门、学过些基础或者是个网站开发老手，你都能在这里找到有用的资源加以绝佳的练习。这些资源都来自卓有远见的公司和乐于接受开放标准网站开发人员。这是网站开发的绝佳练习而且使用一种开放内容授权，比如[知识共享许可协议](https://www.mozilla.org/en-US/foundation/licensing/website-content/)来提供并允许进行翻译。
...
- [网页的基本构架](https://www.sitepoint.com/basic-structure-of-a-web-page/) _（由出版社提供）_
  - : 学习 HTML 元素是如何组装在一起从而构成一个更大的图块的。
- [MDN 的 HTML 元素参考](/zh-CN/docs/Web/HTML/Element)
  - : 一个 HTML 元素综合性性参考，还有不同浏览器对它们的支持。
- [HTML 挑战](https://en.wikiversity.org/wiki/Web_Design/HTML_Challenges)_（来自维基大学）_
...
- [HTML5 入门](https://www.html5rocks.com/tutorials/)_（HTML5 Rocks）_
  - : 通过指南来指导使用 HTML5 特征来写代码。
- [HTML5 语法](https://alistapart.com/article/semanticsinhtml5/) _(分开的列表)_
  - : 学习那些可扩展和向后和向前兼容的有意义的标签语法。
- [Canvas 入门](/zh-CN/docs/Canvas_tutorial)
  - : 学习如何使用脚本和 canvas 标签来画图。
- [HTML5 博士](http://html5doctor.com/)
  - : HTML5 应用前线上的文章。
- [HTML5 声音标签的乐趣](https://www.elated.com/html5-audio/)_（兴趣勃勃啊）_
...
- [Codecademy](https://www.codecademy.com/) *（*来自 Codecademy 网站*）*
...
- [JavaScript 最佳实践](https://blogs.opera.com/news/) _（来自 WebPlatform.org 网站）_
  - : 学习一些明显或者不是很明显的编写 JavaScript 最佳实践。
- [CodeAvengers](https://www.codeavengers.com/)_（来自 CodeAvengers.com 网站）_
...
- [Eloquent JavaScript](https://eloquentjavascript.net/1st_edition/contents.html)
  - : 一本中级和高级 JavaScript 使用方法的全面指南。（译者注：简体中文版《JavaScript 编程精解》已由机械工业出版社华章公司出版发行）
- [必要的 JavaScript 设计模式](https://addyosmani.com/resources/essentialjsdesignpatterns/book/) _(Addy Osmani)_
  - : 介绍基本的 JavaScript 设计模式。
- [JavaScript 编程语言](https://clarle.github.io/yui3/blog/2007/01/24/video-crockford-tjpl/) _(YUI Blog)_
...
- [学习高级别的 JavaScript](https://johnresig.com/apps/learn/) _(John Resig)_
  - : John Resig 的高级 JavaScript 指南。
- [介绍 JavaScript DOM](https://www.elated.com/javascript-dom-intro/) (Elated)
  - : DOM 是什么，以及为什么有用？这篇文章将向你介绍 Javascript 这一强大功能。
- [一个麻烦的 API : DOM 理论](https://clarle.github.io/yui3/blog/2006/10/20/video-crockford-domtheory/) (YUI Blog)
  - : Douglas Crockford 解释文件对象模型。
- [Javascript 进阶](https://clarle.github.io/yui3/blog/2006/11/27/video-crockford-advjs/) (YUI Blog)
...
- [非阻塞 JavaScript 加载](https://clarle.github.io/yui3/blog/2008/07/22/non-blocking-scripts/) (YUI Blog)
...
- [CSS 类选择器](https://en.wikiversity.org/wiki/Web_Design/CSS_Classes) (来自维基大学)
  - : 在 CSS 里类是什么？
- [外部 CSS](https://en.wikiversity.org/wiki/Web_Design/External_CSS) (来自维基大学)
  - : 从外部样式表使用 CSS。
- [添加一点样式](https://www.w3.org/MarkUp/Guide/Style) (W3C)
  - : 入门介绍使用 CSS 样式化网页。
- [常见 CSS 问题](/zh-CN/docs/Learn/CSS/Howto/CSS_FAQ)
  - : 初学者一些常见问题和解答。
- [代码复仇者](https://www.codeavengers.com/) (CodeAvengers.com)
...
- [CSS 挑战](https://en.wikiversity.org/wiki/Web_Design/CSS_challenges) (维基大学)
  - : 让你的 CSS 技巧更灵活，看你是否需要更多的练习。
- [中级 CSS 概念](http://html.net/tutorials/css/) (HTML.net)
  - : 分组，伪类等等。
- [CSS 定位 101](https://alistapart.com/article/css-positioning-101/) (A List Apart)
  - : 使用符合标准的定位，无表布局。
- [CSS 渐进增强](https://alistapart.com/article/progressiveenhancementwithcss/) (A List Apart)
  - : 把 CSS 渐进增强结合到你的网页。
- [流体网格](https://alistapart.com/article/fluidgrids/) (A List Apart)
...
- [应用网页字体快速指南 - 使用 @font-face](https://www.html5rocks.com/tutorials/webfonts/quick/) (HTML5 Rocks)
  - : 来自 CSS3 的 @font-face 功能，允许你以可访问的，可操作的，易扩展的方式使用 web 上的自定义字体。
- [开始写 CSS](https://davidwalsh.name/starting-css) (David Walsh)
