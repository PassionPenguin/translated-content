...
这就我们的简单例子，如果你想继续了解，你可以[在 GitHub 上查看](https://github.com/mdn/web-components-examples/tree/main/simple-template)（另见[在线运行](https://mdn.github.io/web-components-examples/simple-template/)）。
...
> **备注：** 你可以在 [element-details](https://github.com/mdn/web-components-examples/tree/main/element-details) 查看这个完整的例子（另见[在线运行](https://mdn.github.io/web-components-examples/element-details/)）。
