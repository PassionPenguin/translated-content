...
从 [Gecko](zh-CN/Gecko) 1.9（[Firefox 3](zh-CN/Firefox_3) [Firefox bug 111207](https://bugzilla.mozilla.org/show_bug.cgi?id%3D111207)）开始，基于 Gecko 的应用支持 `clientLeft` 属性。该属性在 Firefox 2 及更早的版本中不被支持。
