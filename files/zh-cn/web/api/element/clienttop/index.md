...
基于 [Gecko](/zh-CN/docs/Web/API/en/Gecko) 的应用从 Gecko 1.9（[Firefox 3](/zh-CN/docs/Web/API/en/Firefox_3) [Firefox bug 111207](https://bugzilla.mozilla.org/show_bug.cgi?id%3D111207)）开始支持 clientTop。该属性在 Firefox 2 或更早的版本中不被支持。
...
Cat image and text coming from [www.best-cat-art.com](https://www.catwiki.com/)
