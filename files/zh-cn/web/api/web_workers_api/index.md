...
> **备注：** 根据 [web worker 规范](https://html.spec.whatwg.org/multipage/workers.html#runtime-script-errors-2)，worker 错误事件不应该冒泡（参见 [Firefox bug 1188141](https://bugzilla.mozilla.org/show_bug.cgi?id%3D1188141)）。该规范已在 Firefox 42 中实现。
