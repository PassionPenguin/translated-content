...
你可以看到[实例演示](https://mdn.github.io/web-dictaphone/)或是 Github 上的[源码](https://github.com/mdn/web-dictaphone)（也可以点此[直接下载](https://codeload.github.com/mdn/web-dictaphone/zip/main)）。
