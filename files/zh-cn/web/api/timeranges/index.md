...
术语"[normalized TimeRanges object](https://html.spec.whatwg.org/multipage/iframe-embed-object.html#normalized-timeranges-object)"指出这种对象中的范围时有序的，不重叠的，不为空并且不接触的（相邻范围被折叠成更大的范围）。
