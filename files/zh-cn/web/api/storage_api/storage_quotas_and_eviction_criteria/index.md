...
- [在移动浏览器上使用配额](https://www.html5rocks.com/en/tutorials/offline/quota-research/)（[Eiji Kitamura](https://blog.agektmr.com/)著）：详细分析了移动浏览器上的客户端存储。
- [配额管理 API：快速实践](https://web.dev/articles/storage-for-the-web) （[Eiji Kitamura](https://blog.agektmr.com/)著）：查看 Chrome / Blink 中的配额管理 API（也应包括 Opera）。
