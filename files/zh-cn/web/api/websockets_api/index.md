...
- [µWebSockets](https://github.com/uNetworking/uWebSockets)：由 [C++11](https://isocpp.org/) 和 [Node.js](https://nodejs.org/enen/enenen/en/en) 实现的高度可扩展的 WebSocket 服务器和客户端。
- [Socket.IO](https://socket.io/)：基于长轮询和 WebSocket 的 [Node.js](https://nodejs.org/enen/enenen/en) 第三方传输协议。
- [SocketCluster](https://socketcluster.io/)：适用于 [Node.js](https://nodejs.org/enen/enenen/en) 的 pub/sub WebSocket 框架，注重可扩展性。
- [WebSocket-Node](https://github.com/theturtle32/WebSocket-Node)：用 [Node.js](https://nodejs.org/enen/enenen/en/en) 实现的 WebSocket 服务器 API。
- [Total.js](https://www.totaljs.com/)：用 [Node.js](https://nodejs.org/enen/enenen/en/en) 实现的 Web 应用程序框架（例如：[WebSocket 聊天](https://github.com/totaljs/examples/tree/master/websocket)）。
- [Faye](https://www.npmjs.com/package/faye-websocket)：用于 [Node.js](https://nodejs.org/enen/enenen/en) 服务器和客户端的 {{DOMxRef("WebSocket")}}（双向连接）和 [EventSource](/zh-CN/docs/Web/API/EventSource)（单向连接）。
...
- [ws](https://github.com/websockets/ws)：流行的 WebSocket 客户端和服务器 [Node.js](https://nodejs.org/enen/enenen/en/en) 库。
