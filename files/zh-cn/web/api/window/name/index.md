...
在某些框架里（如，[SessionVars](https://www.thomasfrank.se/sessionvars.html) 和 Dojo's [dojox.io.windowName](https://www.sitepen.com/blog/2008/07/22/windowname-transport) ，该属性也被用于作为 JSONP 的一个更安全的备选，来提供跨域通信（cross-domain messaging）。现代 web 应用应使用 [postMessage API](/zh-CN/docs/Web/API/Window/postMessage) 进行敏感的跨域通信。
