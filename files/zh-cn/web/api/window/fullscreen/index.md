...
- 这个属性仅在 Mozilla 1.9（Firefox 3）及之后才有意义。Mozilla 1.8 及早期版本确实有这个属性，但它总是返回 false，即使在窗口确实处于全屏模式的情况下 ([Firefox bug 127013](https://bugzilla.mozilla.org/show_bug.cgi?id%3D127013))。
