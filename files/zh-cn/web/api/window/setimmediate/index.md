...
> **备注：** 该方法可能不会被批准成为标准，目前只有最新版本的 Internet Explorer 和 Node.js 0.10+ 实现了该方法。它遇到了 [Gecko](https://bugzilla.mozilla.org/show_bug.cgi?id=686201)(Firefox) 和[Webkit](https://bugs.chromium.org/p/chromium/issues/detail?id%3D146172) (Google/Apple) 的阻力。
...
该方法可以用来替代 `setTimeout(fn, 0)` 去执行[繁重的操作](https://humanwhocodes.com/blog/2009/08/11/timed-array-processing-in-javascript/)([heavy operations](https://humanwhocodes.com/blog/2009/08/11/timed-array-processing-in-javascript/))
...
所有这些技术都被纳入 [robust setImmediate polyfill](https://github.com/YuzuJS/setImmediate) 中。
