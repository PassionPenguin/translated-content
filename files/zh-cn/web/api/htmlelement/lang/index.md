...
该属性返回的语言代码（language code）被定义在 [RFC 1766](https://datatracker.ietf.org/doc/html/rfc1766)。通常，"en" 表示英语（English）、"ja" 表示（Japanese）、"zh-cn" 表示简体中文等等。该属性的默认值未知（`unknown`）。尽管该属性可以应用在单独的元素上，但是通常在文档的根元素（html）上指定。
