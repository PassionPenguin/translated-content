...
在下面这个例子中，获取从 {{domxref("MediaStreamTrackProcessor")}} 中返回的帧，然后对他们进行编码。在文章[使用 WebCodec 处理视频](https://developer.chrome.com/docs/web-platform/best-practices/webcodecs)查看完整示例并了解更多细节。
...
- [使用 WebCodec 处理视频](https://developer.chrome.com/docs/web-platform/best-practices/webcodecs)
