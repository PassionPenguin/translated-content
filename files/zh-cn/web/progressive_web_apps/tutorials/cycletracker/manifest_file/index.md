...
查看 [`cycletracker.json` 文件](https://mdn.github.io/pwa-examples/cycletracker/Manifest_file/cycletracker.json)和在 GitHub 上查看[项目源代码](https://github.com/mdn/pwa-examples/tree/main/cycletracker/Manifest_file)。
