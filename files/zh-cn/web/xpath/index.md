...
> **备注：** XPath 的浏览器支持差别很大；它在 Firefox 中得到来相当不错的支持（尽管没有计划进一步改进的计划），而其他浏览器则较小程度地实现了它（如果支持的话）。如果你需要 polyfill，你可以考虑使用 [js-xpath](https://master.dl.sourceforge.net/project/js-xpath/js-xpath/1.0.0/xpath.js?viasf%3D1) 或 [wicked-good-xpath](https://github.com/google/wicked-good-xpath)。
