...
- [https://example.com/#:~:text%3Dfor](https://example.com/#:~:text%3Dfor) 滚动到文档中第一次出现“for”文本的地方并高亮它。
...
- [https://example.com/#:~:text%3Dasking-%2Cfor](https://example.com/#:~:text%3Dasking-%2Cfor) 滚动到文档中第二次出现“for”文本的地方并高亮它。
