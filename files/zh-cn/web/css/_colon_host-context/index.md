...
下边的代码片段来自 [host-selectors 示例](https://github.com/mdn/web-components-examples/tree/main/host-selectors)（[也可以在线查看](https://mdn.github.io/web-components-examples/host-selectors/)）。
