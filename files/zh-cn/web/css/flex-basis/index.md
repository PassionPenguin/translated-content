...
- `content`
  ...
  - : 基于 flex 的元素的内容自动调整大小。
    ...
    > **备注：**由于最初规范中没有包括这个值，在一些早期的浏览器实现的 flex 布局中，content 值无效，可以利用设置 ([width](https://drafts.csswg.org/css2/#propdef-width) 或 [height](https://drafts.csswg.org/css2/#propdef-height)) 为 auto 达到同样的效果。
    ...
    > - 然后呢，这个更改又在 [bug 1093316](https://bugzilla.mozilla.org/show_bug.cgi?id=1093316) 中被撤销了，所以 "auto" 变回了原来的含义; 而一个新的关键字 'content' 变成了自动尺寸。 ([Firefox bug 1105111](https://bugzilla.mozilla.org/show_bug.cgi?id%3D1105111) 包括了增加这个关键字).
