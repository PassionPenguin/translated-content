...
- [Chromium issue 46543：自动填充输入文本框黄色背景高亮无法关闭](https://bugs.chromium.org/p/chromium/issues/detail?id%3D46543)
- [WebKit bug 66032：允许网站开发者覆盖自动填充字段的颜色。](https://bugs.webkit.org/show_bug.cgi?id%3D66032)
- [Mozilla bug 740979：在具有自动填充值的输入元素上实现 `:-moz-autofill` 伪类](https://bugzilla.mozilla.org/show_bug.cgi?id%3D740979)
