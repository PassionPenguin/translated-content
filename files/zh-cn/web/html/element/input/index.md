...
> **备注：** Firefox 在许多版本中支持一个专有的错误属性——`x-moz-errormessage`，它允许你以类似的方式设置自定义错误信息。从第 66 版开始，这个属性已被移除（见[Firefox bug 1513890](https://bugzilla.mozilla.org/show_bug.cgi?id%3D1513890)）。
...
- [快速测试：大型点击目标——The A11Y Project](https://www.a11yproject.com/posts/large-touch-targets/)
