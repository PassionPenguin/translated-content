...
你还可以从 [GitHub](https://github.com/)、[GitLab](https://about.gitlab.com/) 或 [BitBucket](https://bitbucket.org/product/) [导入 Svelte git 项目](https://vercel.com/new/clone?repository-url%3Dhttps://github.com/vercel/vercel/tree/main/examples/svelte)到 Vercel 中。
...
我们将把我们的待办事项应用部署到 [GitLab Pages](https://docs.gitlab.com/ee/user/project/pages/)，借此来演示这一点。

1. 首先，你需要[在 GitLab 注册](https://gitlab.com/users/sign_up)，然后[创建一个新项目](https://gitlab.com/users/sign_in)。给你的新项目取一个简短、简单的名称，比如“mdn-svelte-todo”。你将获得指向你的新 GitLab 存储库的远程 URL，例如 `git@gitlab.com:[你的用户名]/[你的项目名].git`。
...
要深入了解 Svelte 并学习更多关于它的知识，你一定要访问 [Svelte 主页](https://svelte.dev/)。在那里，有[许多文章](https://svelte.dev/blog)解释 Svelte 的理念。如果你还没有这样做，一定要完成 [Svelte 交互式教程](https://learn.svelte.dev/tutorial/welcome-to-svelte)。我们已经涵盖了大部分内容，所以你不需要花费太多时间来完成它，你可以将其视为实践！
