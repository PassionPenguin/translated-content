...
有很多的[理由](https://web.dev/learn/performance/why-speed-matters)告诉你为什么你的网站需要尽可能好的性能。下面是关于最佳实践，工具，API 以及链接的简明介绍，它为每个主题提供了更多的信息。意识到对用户来说什么是真正重要的也至关重要，他可能不是绝对意义上的时间而是[用户感知的时间](/zh-CN/docs/Learn/Performance/perceived_performance)。
...
- [Lighthouse](https://developer.chrome.com/docs/lighthouse/overview/) 可以给你一份有关你网站的包括性能，SEO 和无障碍等多个方面的详细分类。
- 使用 [Webpagetest.org](https://www.webpagetest.org/)检测页面在不同真实设备类型和地点时候的速度。trics.
