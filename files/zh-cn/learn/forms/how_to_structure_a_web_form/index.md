...
许多辅助技术将使用{{HTMLElement("legend")}} 元素，就好像它是相应的 {{HTMLElement("fieldset")}} 元素里每个部件的标签的一部分。例如，在说出每个小部件的标签之前，像[Jaws](https://www.freedomscientific.com/products/fs/jaws-product-page.asp)或[NVDA](https://www.nvaccess.org/)这样的屏幕阅读器会朗读出 legend 的内容。
