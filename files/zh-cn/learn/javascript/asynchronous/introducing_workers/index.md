...
在这个例子中，首先在 [https://github.com/mdn/learning-area/tree/main/javascript/asynchronous/workers/start](https://github.com/mdn/learning-area/tree/main/javascript/asynchronous/workers/start) 将文件拷贝到本地。在这个目录下有四个文件：
