...
再者，合法标记可以让那些给你的网站做预处理的工具功能最大化。例如，[HTML Tidy](https://sourceforge.net/projects/html-tidy.mirror/) 可以移除空白符和可选的结束标记；然而，在有严重的错误标记的网页中这些工具便无法工作。
...
- 书籍：Andy King 撰写的[让你的站点访问更快](https://www.websiteoptimization.com/403.shtml)
- 非常棒、讲的很全的[加快站点访问的最佳实践](https://developer.yahoo.com/performance/rules.html)资料（来自 Yahoo!）
- 用来分析和优化的工具：[Google PageSpeed 工具](https://developers.google.cn/speed?hl%3Dzh-cn)
