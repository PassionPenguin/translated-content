...
```html example-good
<p><a href="https://www.mozilla.org/en-US/firefox/"> 下载 Firefox </a></p>
```

**不好的**链接文本：[点击这里](https://www.mozilla.org/en-US/firefox/)下载 Firefox

```html example-bad
<p><a href="https://www.mozilla.org/en-US/firefox/"> 点击这里 </a>下载 Firefox</p>
```
