...
- Boolean（其源自英国数学家和逻辑学家的姓名 [George Boole](https://zh.wikipedia.org/wiki/乔治%C2%B7布尔)）
...
- 确保媒体许可证允许你使用它们。尽量使用具有非常宽松许可的媒体，如 [CC0](https://creativecommons.org/public-domain/cc0/) 或至少与我们的一般内容许可兼容的媒体——[知识共享署名——相同方式共享许可](https://creativecommons.org/licenses/by-sa/2.5/)（CC-BY-SA）。
...
如果你在撰写过程中或在格式方面遇到了本文尚未提及的问题，我们建议你参考[微软的风格指南](https://learn.microsoft.com/zh-cn/style-guide/welcome/)，如果还是不能解决问题，还可参考[芝加哥格式指南](https://www.chicagomanualofstyle.org/home.html)，网络上有一份非官方的 [PDF 版本](https://faculty.cascadia.edu/cma/HIST148/cmscrib.pdf)。
...
- [英语语法 FAQ](https://websites.umich.edu/~jlawler/aue.html)
...
- [StackExchange 网站的英语子站](https://english.stackexchange.com/)，关于英语使用的问答网站。
