...
模拟监控涉及部署脚本来模拟最终用户可能在 Web 应用程序中执行的路径，并报告模拟器体验的性能。流行的模拟监控工具示例包括 [WebPageTest](https://www.webpagetest.org/) 和 [Lighthouse](https://developer.chrome.google.cn/docs/lighthouse/overview?hl%3Dzh-cn)。测量的流量不是实际用户的流量，而是为收集页面性能数据而综合生成的流量。
