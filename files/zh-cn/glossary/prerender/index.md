...
- developer.chrome.google.cn 上的[在 Chrome 中预渲染页面，以实现快速的页面导航](https://developer.chrome.google.cn/docs/web-platform/prerender-pages?hl%3Dzh-cn#prerendering-from-the-address-bar)（2023）
